...
if __name__ == '__main__':
    ...
    Button(root, text='开启服务', command=start).place(relx=0.8, rely=0.05, anchor=CENTER)
    Button(root, text='更换网址', command=show_qrc).place(relx=0.8, rely=0.15, anchor=CENTER)
    Button(root, text='文件所在', command=open_dir).place(relx=0.8, rely=0.25, anchor=CENTER)
    l = Label(root)
